...
export default function RootLayout({ children }) {
  ...
  const footerLinks = {
    ...
    services: [
      { href: "/premium-membership", label: "Premium Membership" },
          ...
          <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <footer className="bg-gradient-to-br from-gray-800 to-gray-900 text-white pt-12 pb-6 shadow-inner">
              <div className="container mx-auto px-4">
                ...
                <div className="mt-12 bg-gray-900 bg-opacity-50 rounded-xl p-6 lg:p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 mb-4">
                        Stay updated with our latest matches and offers.
                      </p>
                      <form className="flex flex-col sm:flex-row gap-2">
                        <input
                          type="email"
                          placeholder="Your email address"
                          className="px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 flex-grow"
                          required
                        />
                        <button
                          type="submit"
